    ...
    return (
      ...
      <main className="min-h-screen overflow-hidden bg-orange-200 px-5 py-7 text-[#4a3426] md:hidden">
        ...
        <section className="mx-auto max-w-md text-center">
          <img src={mau} alt="Mansi" className="mx-auto mt-4 w-52" />
          <img src={tag} alt="Services" className="mx-auto -mt-12 w-80" />
          ...
          <div className="mt-8 grid grid-cols-2 gap-4">
            {[
              [reels, "Reels"], [ugc, "UGC"], [sponsored, "Sponsored"], [brand, "Brand collaborations"],
              [review, "Reviews"], [stories, "Stories"], [fashion, "Fashion"], [lifestyle, "Lifestyle"],
              [food, "Food"], [tech, "Tech"],
            ].map(([image, label]) => <article key={label} className="rounded-3xl bg-orange-100 p-2 shadow-sm"><img src={image} alt={label} loading="lazy" className="w-full" /><p className="pb-1 font-[font10] text-lg">{label}</p></article>)}
          </div>
