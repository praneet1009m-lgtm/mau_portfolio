  ...
  return (
    ...
    <>
      <main className="min-h-screen overflow-hidden bg-orange-300 px-4 py-5 text-[#3f2e25] md:hidden">
        <div className="relative mx-auto flex min-h-[calc(100vh-2.5rem)] max-w-md flex-col items-center overflow-hidden rounded-[2.5rem] bg-orange-200 px-6 pb-8 pt-10 text-center shadow-sm">
          ...
          <nav aria-label="Main navigation" className="mt-7 grid w-full grid-cols-3 gap-2 font-[font10] text-lg">
            <Link to="/about" className="rounded-full border border-[#a88255] px-2 py-2">About</Link>
            <Link to="/services" className="rounded-full border border-[#a88255] px-2 py-2">Work</Link>
            <Link to="/contact" className="rounded-full border border-[#a88255] px-2 py-2">Contact</Link>
          </nav>
          <div className="mt-4 flex gap-3 font-[font10] text-lg underline">
            <a href="https://www.youtube.com/@MansiMauu">YouTube</a>
            <a href="https://www.instagram.com/mansiooforsuree">Instagram</a>
          </div>
        </div>
      </main>
