  ...
  return (
    ...
    <main className="min-h-screen overflow-hidden bg-orange-200 px-5 py-7 text-[#3f2e25] md:hidden">
      ...
      <section className="mx-auto mt-5 max-w-md text-center">
        <div className="relative mx-auto h-64 w-64"><img src={mau} alt="Mansi" className="absolute inset-5 h-[216px] w-[216px] object-cover" /><img src={frame} alt="" className="absolute inset-0 h-full w-full" /></div>
        ...
        <p className="mt-5 font-[font7] text-xl leading-relaxed">The Mau Tales is not just a channel, it’s a part of me.</p><p className="mt-5 font-[font9] text-2xl text-[#b7724c]">Thanks for being here!</p>
        <Link to="/contact" className="my-8 inline-block rounded-full border border-[#a88255] px-5 py-2 font-[font10] text-xl">Let&apos;s connect</Link>
      </section>
    </main>
